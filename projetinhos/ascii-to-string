...
encodedString = prompt('Qual código invertido ascii deseja converter?'); // recebe parâmetro
...
/*
 33795010012390111166 | "Bom dia!" invertido
 101211501801101070 | "Felipe" invertido, porém com primeiro termo igual a 0 - teste de validação
 */
